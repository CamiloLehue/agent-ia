...
function ChatResults({
  ...
  return (
    <div
      ref={boxRef}
      className={`w-full transition-all duration-500 ease-in-out h-[512px]  shadow-2xl rounded-t-xl p-5 flex flex-col opacity-100`}
    >
        ...
        {messages.length === 0 && !loading && (
          <div className="text-center text-primary/50 py-8">
            ...
            <p className="text-xs mt-2 opacity-70">
              Puedes seleccionar elementos de los botones Superiores para
              incluirlos en tu consulta.
            </p>
          </div>
        )}
        ...
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              <div
                className={`text-xs text-primary/50 mt-1 ${
