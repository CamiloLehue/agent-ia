      ...
      >
            ...
            <div className="flex flex-wrap gap-1">
              ...
              >
                ...
                <h5 className="text-primary/70">
                  {isSelected.name}{" "}
                  <span className="text-xs opacity-50">#{isSelected.id}</span>
                </h5>
              </div>
            </div>
          )}
        ...
        <div className="px-5 py-2 bg">
          <form
            ...
            className="w-full h-10 px-5 grid grid-cols-12 bg-accent/20 rounded-lg "
          >
            ...
            isSelected?.id === 3 ? (
              <input
                ...
                placeholder={
                  isListening
                    ? "🎤 Escuchando..."
                    : "Hazme una pregunta aquí..."
                }
                className={`px-10 w-[95%] h-full col-span-10 outline-none text-white p-2 text-sm bg-transparent transition-all duration-200 ${
                  isListening
              ...
              <input
                ...
                onKeyPress={handleKeyPress}
                placeholder={
                  isListening ? "🎤 Escuchando..." : "Selecciona una opción"
                }
                className={`px-10 w-[95%] h-full col-span-10  outline-none text-white p-2 text-sm bg-accent/90  transition-all duration-200 ${
                  isListening
