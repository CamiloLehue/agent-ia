        ...
        <div
            ...
            className="w-full flex justify-center items-center relative">
            {
                ...
                <div className="absolute right-0 transition-all duration-500">
                    <div className="absolute right-0 top-0 w-21 h-2 bg-secondary"></div>
                    <div className="absolute right-0 top-0.5 w-20 h-1 bg-danger blur-sm"></div>
                    <div className="absolute right-0 top-0.5 w-20 h-1 bg-danger"></div>
                </div>
            }
                ...
                <div className={` 
                    ...
                    <div className={`relative w-full h-full  rounded-xl border-t border-primary/20 shadow-md shadow-black/10 transition-all duration-1000 ease-in-out
                        ...
                        <div className='flex justify-center items-center w-full h-full overflow-hidden'>
                            <div className="absolute w-10 h-20 bg-danger rounded-full blur-xl bottom-0 left-0 "></div>
