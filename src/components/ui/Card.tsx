    ...
    return (
        <div
            ...
            <div className="relative group h-40 w-40 p-5 cursor-pointer">
                <div className="absolute left-[50%] top-0 -translate-x-1/2 w-[calc(100%-5rem)] mx-auto rounded-full h-[calc(100%-2rem)] translate-y-10 bg-primary/10 blur-xl transition-all duration-200 ease-in-out"></div>
                <div className={` 
                        ${isSelected
                        ? "bg-black/50"
                        : "bg-black"
                    } 
                        relative w-full h-full  rounded-2xl p-2 overflow-hidden border-b border-b-primary/30 border-t-2 border-t-black/1`}>
                    ...
                    <div className={`relative w-full h-full  rounded-xl border-t border-primary/20 shadow-md shadow-black/10 transition-all duration-1000 ease-in-out
                        ...
                        <div className='flex justify-center items-center w-full h-full overflow-hidden'>
                            <div className="absolute w-10 h-10 bg-black rounded-full blur-xl bottom-0 left-0 "></div>
                            <div className="absolute w-10 h-10 bg-primary/50 rounded-full blur-xl top-0 right-0 "></div>
